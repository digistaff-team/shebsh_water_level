...
export const fetchRawTextFromUrl = async (): Promise<string> => {
  ...
  const message = `/clear ## Запусти функцию №18 'get_text_from_url', прочитай со страницы ${TARGET_URL} сведения о текущем уровне воды и изменении уровня за прошедшие 24 часа и верни СТРОГО в формате: 'Уровень воды: XXX см. Изменение за 24 часа: YYY см.' (где XXX и YYY - числа с возможным знаком минус и дробной частью)`;
